...
class CookieJarTest extends TestCase
{
    ...
    public function testUpdateFromSetCookie()
    {
        ...
        $this->assertInstanceOf('Clyo\Cookie', $cookieJar->get('foo'));
        $this->assertInstanceOf('Clyo\Cookie', $cookieJar->get('bar'));
    ...
    public function testUpdateFromSetCookieWithMultipleCookies()
    {
        ...
        $this->assertInstanceOf('Clyo\Cookie', $fooCookie);
        $this->assertInstanceOf('Clyo\Cookie', $barCookie);
        $this->assertInstanceOf('Clyo\Cookie', $phpCookie);
