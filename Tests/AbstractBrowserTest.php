...
class AbstractBrowserTest extends TestCase
{
    ...
    {
        $this->expectException('Clyo\Exception\BadMethodCallException');
        $this->expectExceptionMessage('The "request()" method must be called before "Clyo\\AbstractBrowser::getRequest()".');
    ...
    public function testGetResponse()
    {
        ...
        $this->assertInstanceOf('Clyo\Response', $client->getResponse(), '->getCrawler() returns the Response of the last request');
    }

    public function testGetResponseNull()
    {
        $this->expectException('Clyo\Exception\BadMethodCallException');
        $this->expectExceptionMessage('The "request()" method must be called before "Clyo\\AbstractBrowser::getResponse()".');
    ...
    {
        $this->expectException('Clyo\Exception\BadMethodCallException');
        $this->expectExceptionMessage('The "request()" method must be called before "Clyo\\AbstractBrowser::getInternalResponse()".');
    ...
    {
        $this->expectException('Clyo\Exception\BadMethodCallException');
        $this->expectExceptionMessage('The "request()" method must be called before "Clyo\\AbstractBrowser::getCrawler()".');
    ...
    public function testInsulatedRequests()
    {
        $client = $this->getBrowser();
        $client->insulate();
        $client->setNextScript("new Clyo\Response('foobar')");
        $client->request('GET', 'http://www.example.com/foo/foobar');
    ...
    public function testInternalRequest()
    {
        ...
        $this->assertInstanceOf('Clyo\Request', $client->getInternalRequest());
    }

    public function testInternalRequestNull()
    {
        $this->expectException('Clyo\Exception\BadMethodCallException');
        $this->expectExceptionMessage('The "request()" method must be called before "Clyo\\AbstractBrowser::getInternalRequest()".');
